...
public class DatabaseInit {
    ...
    public void init() throws IOException, URISyntaxException{
        ...
        Recipe recipe14 = new Recipe("Ensalada de garbanzos", 10, "Facil", date, "100g de garbanzos, 1 tomate, 1 cebolla y aliño al gusto", "Rodri_chef", true, true, true, false, false, "Cocer los garbanzos y añadir el tomate y la cebolla cortada, por úlitmo añadir el aliño");
        setRecipeImage(recipe14,"fotoscomida/ensaladaGarbanzos.jpg");
        recipeRepository.save(recipe14);
        Recipe recipe15 = new Recipe("Esparragos trigueros a la plancha", 5, "Facil", date, "Esparragos y aceite", "Rodri_chef", true, false, true, false, false, "Calentar la plancha y ehchar los esparragos hasta que se doren");
